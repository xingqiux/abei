...
export function BillRow({ bill }: { bill: Bill }) {
  ...
  return (
    <div className="flex h-8 items-center gap-3 rounded-[4px] px-2 text-[12.5px]">
      ...
      <div className="font-mono tabular-nums w-[170px] shrink-0 text-right text-[11.5px] text-gray-500 dark:text-gray-400">
        {amountRange}
      </div>
      <div className="w-[64px] shrink-0 text-center text-[11.5px] text-gray-500 dark:text-gray-400">
        {periodLabel}
      </div>
      <div className="font-mono tabular-nums w-[90px] shrink-0 text-right text-[11.5px] text-gray-500 dark:text-gray-400">
