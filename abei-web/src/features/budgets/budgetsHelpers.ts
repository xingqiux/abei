...
/** /budgets 的 ?view= 校验（默认 budgets，所以只需认出 subscriptions） */
export function isBudgetsTab(value: unknown): value is BudgetsTab {
  return value === 'budgets' || value === 'subscriptions'
}
