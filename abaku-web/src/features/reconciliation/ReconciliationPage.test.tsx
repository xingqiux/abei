...
vi.mock('../../components/abaku/EmptyState', () => ({ EmptyState: () => null }))
vi.mock('../../components/abaku/CelebrateOverlay', () => ({ CelebrateOverlay: () => null }))
vi.mock('../../components/abaku/ErrorState', () => ({ ErrorState: () => null }))
