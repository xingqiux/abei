...
export function DateRangePicker({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <Popover className="relative shrink-0">
      <PopoverButton className="flex items-center gap-1.5 rounded-md px-2 py-1.5 font-mono text-[11.5px] text-[var(--text-secondary)] transition-colors hover:bg-[var(--surface-hover)] data-open:bg-[var(--surface-hover)]">
