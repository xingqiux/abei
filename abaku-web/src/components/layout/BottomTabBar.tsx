...
export function BottomTabBar() {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-[150] flex h-16 items-stretch border-t border-[var(--border-subtle)] bg-[var(--surface-1)] shadow-[0_-4px_16px_rgb(0_0_0/0.06)] md:hidden  "
    ...
    >
      ...
      <div className="flex flex-1 items-center justify-center">
        <button
          ...
          aria-label="记一笔"
          className="flex h-12 w-12 -translate-y-3 items-center justify-center rounded-full bg-[var(--brand)] text-white shadow-lg hover:bg-[var(--brand-hover)]"
        >
      ...
      <span className="relative">
        ...
        {showDot && (
          <span
            ...
            style={{ background: dotKind === 'danger' ? 'var(--danger)' : 'var(--attention)' }}
          />
        )}
      </span>
      {label}
